...
export default function ProfileStep({ onNext, onSkip, isAddingFamilyMember = false, mode = "extended", initialData }: Props) {
  ...
  const handleSubmit = () => {
    ...
    const profileData: ProfileData = {
      ...
      referralName: (sourceOfPatient === "Referral" || sourceOfPatient === "Doctor") ? referralName.trim() || undefined : undefined,
      referralPhone: (sourceOfPatient === "Referral" || sourceOfPatient === "Doctor") ? referralPhone.trim() || undefined : undefined,
  ...
  return (
    <div className="space-y-6">
      ...
      {!isMinimalMode && (
        <>
          {/* Progress Bar for Extended Profile - 5 Steps */}
          {!isAddingFamilyMember && <ProgressBar currentStep={3} totalSteps={5} />}
