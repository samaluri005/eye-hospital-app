...
export default function PhoneStep({ initialPhone = "", onSent }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Single Trust Line - HIPAA + reCAPTCHA */}
      <div className="text-center">
        <p className="text-xs text-gray-500 flex items-center justify-center gap-2">
          ...
          <span>
            HIPAA compliant • Protected by reCAPTCHA (
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Privacy</a>
            {' • '}
